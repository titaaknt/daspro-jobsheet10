                    ...
                    while (true) {
                        while (true) {
                            ...
                            if (baris >= 1 && baris <= 4) {
                                ...
                                System.out.println("Baris tidak valid! Harap masukkan angka antara 1 dan 4.");
                            }
                        }
                        while (true) {
                            ...
                            if (kolom >= 1 && kolom <= 2) {
                                ...
                                System.out.println("Kolom tidak valid! Harap masukkan angka antara 1 dan 2.");
                            }
                        }
                        sc.nextLine(); 
                    ...
                    for (int i = 0; i < penonton.length; i++) {
                        for (int j = 0; j < penonton[i].length; j++) {
                            if (penonton[i][j] != null) {
                                ...
                                System.out.printf("Baris %d, Kolom %d: * (Kursi Kosong)\n", i + 1, j + 1);
                            }
                        }
                    }
                    if (!adaPenonton) {
